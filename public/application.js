...
var config = {
  apiOrigins: {
    ...
    production: 'https://restaurant-randomizer-api.herokuapp.com'
  }
};
...
var reuse = __webpack_require__(5);
var dataDisplay = __webpack_require__(12);

var hideAllNavSections = function hideAllNavSections() {
...
var navSigningIn = function navSigningIn() {
  ...
  if (store.user.preference) {
    ...
    store.user.user_selected_categories.map(function (category) {
...
var navPreferences = function navPreferences() {
...
module.exports = {
  ...
  navEnableHome: navEnableHome,
  navDisableHome: navDisableHome
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var store = __webpack_require__(1);
var reuse = __webpack_require__(5);
var navUi = __webpack_require__(6);
var navEvents = __webpack_require__(14);
...
var apiDataDisplay = __webpack_require__(21);
var uiDataDisplay = __webpack_require__(22);
var fourSquareDataRequest = function fourSquareDataRequest() {
  apiDataDisplay.fourSquareCall().then(uiDataDisplay.fourSquareCallSuccess).catch(uiDataDisplay.fourSquareCallFailure);
};

module.exports = {
  fourSquareDataRequest: fourSquareDataRequest
};
...
var apiAuth = __webpack_require__(10);
var uiNav = __webpack_require__(6);
var uiAuth = __webpack_require__(11);
var store = __webpack_require__(1);
var home = function home(event) {
...
var preferences = function preferences(event) {
  if (store.user) {
...
var onSignOut = function onSignOut(event) {
  ...
  apiAuth.signOut().then(uiAuth.signOutSuccess).catch(uiAuth.signOutFailure);
};
...
var addHomeHandler = function addHomeHandler() {
  $('#navHome').on('click', home);
};
var addAllNavHandlers = function addAllNavHandlers() {
  $('#navHome').on('click', home);
...
module.exports = {
  addAllNavHandlers: addAllNavHandlers,
...
var preferencesEvents = __webpack_require__(42);
...
var onSignUp = function onSignUp(event) {
  ...
  if (data.credentials.password === data.credentials.password_confirmation) {
    ...
    .then(function () {
      setTimeout(function () {
        authApi.signIn(data).then(authUi.signInSuccess).catch(authUi.signUpFailure);
      }, 200);
...
var fourSquareCall = function fourSquareCall() {
  return $.ajax({
...
var store = __webpack_require__(1);
var reuse = __webpack_require__(5);
var restarauntDisplayTemplate = __webpack_require__(23);
var noRestarauntAvailableTemplate = __webpack_require__(40);
var restarauntFailureTemplate = __webpack_require__(41);
var updateDisplay = function updateDisplay() {
  ...
  if (store.venues.length > 0) {
    ...
    var showRestaurant = restarauntDisplayTemplate({ venue: store.venues[0] });
    ...
    var _showRestaurant = noRestarauntAvailableTemplate({ venue: store.venues });
    $('.content').append(_showRestaurant);
  }
...
var fourSquareCallSuccess = function fourSquareCallSuccess(data) {
  // FourSquare Call
...
var fourSquareCallFailure = function fourSquareCallFailure(error) {
  // Hides the existing content on the data display / home page
  // Removes all of the previously appended content within it
  console.error(error);
  $('.content').hide();
  ...
  var showFailure = restarauntFailureTemplate({ venue: store.venues });
...
module.exports = {
  fourSquareCallSuccess: fourSquareCallSuccess,
  fourSquareCallFailure: fourSquareCallFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "      <p>"
    + container.escapeExpression(container.lambda(((stack1 = ((stack1 = (depth0 != null ? depth0.venue : depth0)) != null ? stack1.contact : stack1)) != null ? stack1.formattedPhone : stack1), depth0))
    + "</p>\n";
},"5":function(container,depth0,helpers,partials,data) {
    var stack1;

  return "      <h4><a href=\""
    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.venue : depth0)) != null ? stack1.url : stack1), depth0))
    + "\" target=\"_blank\">Website</a></h4>\n      <br/>\n";
},"7":function(container,depth0,helpers,partials,data) {
    var stack1;

  return "      <h4><a href=\""
    + container.escapeExpression(container.lambda(((stack1 = ((stack1 = (depth0 != null ? depth0.venue : depth0)) != null ? stack1.menu : stack1)) != null ? stack1.mobileUrl : stack1), depth0))
    + "\" target=\"_blank\">Menu</a></h4>\n";
},"9":function(container,depth0,helpers,partials,data) {
    return "      <h4>Menu</h4>\n      <p>No menu available</p>\n";
},"11":function(container,depth0,helpers,partials,data) {
    var stack1;

  return "      <div class=\"twitter-timeline container\">\n        <a class=\"twitter-timeline\" data-theme=\"dark\" href=\"https://twitter.com/"
    + container.escapeExpression(container.lambda(((stack1 = ((stack1 = (depth0 != null ? depth0.venue : depth0)) != null ? stack1.contact : stack1)) != null ? stack1.twitter : stack1), depth0))
    + "?ref_src=twsrc%5Etfw\" data-width=\"300\" data-height=\"300\"></a>\n        <script async src=\"//platform.twitter.com/widgets.js\" charset=\"utf-8\"></script>\n      </div>\n      <br/>\n";
  ...
  return "<section>\n  <h1>"
    ...
    + "</h1>\n  <div>\n"
    + ((stack1 = helpers.each.call(alias3,((stack1 = ((stack1 = (depth0 != null ? depth0.venue : depth0)) != null ? stack1.location : stack1)) != null ? stack1.formattedAddress : stack1),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + ((stack1 = helpers["if"].call(alias3,((stack1 = ((stack1 = (depth0 != null ? depth0.venue : depth0)) != null ? stack1.contact : stack1)) != null ? stack1.formattedPhone : stack1),{"name":"if","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "    <br/>\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = (depth0 != null ? depth0.venue : depth0)) != null ? stack1.url : stack1),{"name":"if","hash":{},"fn":container.program(5, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + ((stack1 = helpers["if"].call(alias3,((stack1 = ((stack1 = (depth0 != null ? depth0.venue : depth0)) != null ? stack1.menu : stack1)) != null ? stack1.mobileUrl : stack1),{"name":"if","hash":{},"fn":container.program(7, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "\n"
    + ((stack1 = helpers.unless.call(alias3,((stack1 = ((stack1 = (depth0 != null ? depth0.venue : depth0)) != null ? stack1.menu : stack1)) != null ? stack1.mobileUrl : stack1),{"name":"unless","hash":{},"fn":container.program(9, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "    <br/>\n\n    <div class=\"row\">\n      <div class=\"col-md-4 col-lg-4 col-xl-4\"></div>\n      <div class=\"col-md-4 col-lg-4 col-xl-4\">\n        <div class=\"embed-responsive embed-responsive-4by3\">\n          <iframe class=\".google-map\" width=\"500em\" height=\"450em\" frameborder=\"0\" src=\"https://www.google.com/maps/embed/v1/view?key=AIzaSyDesrBtbwRExdzQejyBJaHPkmeaHLQViSM&center="
    ...
    + "&zoom=19&maptype=satellite\" allowfullscreen>\n      </iframe>\n        </div>\n      </div>\n      <div class=\"col-md-4 col-lg-4 col-xl-4\"></div>\n    </div>\n    <br>\n\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = ((stack1 = (depth0 != null ? depth0.venue : depth0)) != null ? stack1.contact : stack1)) != null ? stack1.twitter : stack1),{"name":"if","hash":{},"fn":container.program(11, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "  </div>\n  <button class=\"restaurantReroll btn btn-primary\">Reroll</button>\n</section>\n";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<section>\n  <h1>There are no more restaurants available for display.</h1>\n  <h1>Please change your preferences or steal someones bagged lunch.</h1>\n  <h1>:(</h1>\n</section>\n";
},"useData":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<section>\n  <h1>The call to FourSquare has failed.</h1>\n  <h1>Please try again later</h1>\n</section>\n";
},"useData":true});
...
var determineUserCategoryChanges = function determineUserCategoryChanges(insertOrDelete) {
  ...
  if (insertOrDelete === 'insert') {
    ...
    var deletionRecords = store.user.user_selected_categories.filter(function (category) {
...
var updateInMemoryUserCategories = function updateInMemoryUserCategories() {
  // Update local list of preferences
  preferenceAPI.userCategoryGet().then(preferenceUi.userCategoryGetSuccess).catch(preferenceUi.preferenceFailure);
};

var onUpdatePreferences = function onUpdatePreferences(event) {
  // Retrieves the form data
  var data = getFormFields(this);
  // Calls functions for creating arrays of data for insertion/deletion
  var categoryIdInserts = determineUserCategoryChanges('insert');
  var categoryRecordDeletes = determineUserCategoryChanges('delete');
  event.preventDefault();

  var categoryAndPreferencePromise = new Promise(function (resolve, reject) {
    if (categoryIdInserts.length !== 0) {
      // Complete needed insert statements
      categoryIdInserts.forEach(function (categoryId) {
        preferenceAPI.userCategoryInsert(categoryId).catch(preferenceUi.preferenceFailure);
      });
    }

    if (categoryRecordDeletes.length !== 0) {
      // Complete needed delete statements
      categoryRecordDeletes.forEach(function (record) {
        preferenceAPI.userCategoryDelete(record.id).catch(preferenceUi.preferenceFailure);
      });
    }
    ...
    if (store.user.preference) {
      ...
      preferenceAPI.updatePreference(data).then(preferenceUi.preferenceUpdateSuccess).catch(preferenceUi.preferenceFailure);
    } else {
      // Preferences record exists.  Insert
      preferenceAPI.createPreference(data).then(preferenceUi.preferenceCreateSuccess).catch(preferenceUi.preferenceFailure);
    }
    resolve(); // fulfilled
  });
...
var onDeletePreferences = function onDeletePreferences(event) {
  if (store.user.preference) {
    // Preferences available for deletion
    preferenceAPI.deletePreference().then(preferenceUi.preferenceDeleteSuccess).catch(preferenceUi.preferenceFailure);
  } else {
...
var onGetAddress = function onGetAddress(event) {
...
function locationRetrievedSuccessfully(pos) {
  var crd = pos.coords;
  preferenceAPI.retrieveAddressFromGoogle(crd).then(preferenceUi.googleRetrievalSuccess).catch(preferenceUi.googleRetrievalFailure);
}
...
var createPreference = function createPreference(data) {
...
var userCategoryGet = function userCategoryGet() {
  return $.ajax({
...
var userCategoryInsert = function userCategoryInsert(categoryId) {
  var insertData = {
...
var userCategoryDelete = function userCategoryDelete(id) {
  return $.ajax({
...
var updatePreference = function updatePreference(data) {
  return $.ajax({
...
var deletePreference = function deletePreference() {
  return $.ajax({
...
var retrieveAddressFromGoogle = function retrieveAddressFromGoogle(crd) {
  var url = 'https://maps.googleapis.com/maps/api/geocode/json?latlng=' + crd.latitude + ',' + crd.longitude + '&key=AIzaSyCwxJaqlOMDni69JHseSy-PHw6MVWHCPFs';
  return $.ajax({
    url: url,
    method: 'GET'
  });
...
module.exports = {
  ...
  userCategoryInsert: userCategoryInsert,
  userCategoryGet: userCategoryGet,
  userCategoryDelete: userCategoryDelete,
  retrieveAddressFromGoogle: retrieveAddressFromGoogle
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var navUi = __webpack_require__(6);
var navEvents = __webpack_require__(14);
var dataDisplayEvents = __webpack_require__(12);

var preferenceCreateSuccess = function preferenceCreateSuccess(data) {
...
var userCategoryGetSuccess = function userCategoryGetSuccess(data) {
  // Stores the users selected categories
  store.user.user_selected_categories = data.user_selected_categories;
};

var userCategoryInsertSuccess = function userCategoryInsertSuccess(data) {
...
var preferenceUpdateSuccess = function preferenceUpdateSuccess(data) {
  store.user.preference = data.preference;
...
var preferenceDeleteSuccess = function preferenceDeleteSuccess(data) {
...
var preferenceChangeMade = function preferenceChangeMade() {
...
var preferenceFailure = function preferenceFailure(error) {
  console.error(error);
  reuse.updateFieldAddRemoveClassMessage('#messageUpdatePreferences', 'Unexpected error', 'alert-danger', 'alert-success');
};

var preferenceDoNotExist = function preferenceDoNotExist() {
...
var googleRetrievalSuccess = function googleRetrievalSuccess(data) {
  $('#preferenceLocation').val(data.results[0].address_components[7].long_name);
  $('#getAddress').prop('disabled', false);
};

var googleRetrievalFailure = function googleRetrievalFailure() {
  reuse.updateFieldAddRemoveClassMessage('#messageUpdatePreferences', 'Unexpected error', 'alert-danger', 'alert-success');
  $('#getAddress').prop('disabled', false);
};

module.exports = {
  preferenceUpdateSuccess: preferenceUpdateSuccess,
  preferenceFailure: preferenceFailure,
  preferenceDeleteSuccess: preferenceDeleteSuccess,
  preferenceDoNotExist: preferenceDoNotExist,
  preferenceCreateSuccess: preferenceCreateSuccess,
  userCategoryInsertSuccess: userCategoryInsertSuccess,
  userCategoryGetSuccess: userCategoryGetSuccess,
  preferenceChangeMade: preferenceChangeMade,
  googleRetrievalSuccess: googleRetrievalSuccess,
  googleRetrievalFailure: googleRetrievalFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
